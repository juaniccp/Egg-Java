...
public class Ejercicio07 {
    public static void main(String[] args) {
        ...
        // Pedimos al usuario que introduzca el tipo de motor
        System.out.print("Introduce el tipo de motor (1-4): ");
        int tipoMotor = scanner.nextInt();

        // Utilizamos una estructura switch para mostrar el mensaje correspondiente
        switch (tipoMotor) {
            case 1:
